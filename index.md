...
- [octoDNS, GitHub Actions, Cloudflare &amp; Digital Ocean – Redundant, Multi-cloud DNS  hosting for free](https://npratley.net/octodns-github-actions-cloudflare-digital-ocean-redundant-multi-cloud-dns-hosting-for-free/)
- [Building and Releasing a Mobile App — Lessons Learnt](https://npratley.net/building-and-releasing-a-mobile-app-lessons-learnt-8db3cc026490/)
- [Building Laravel 8 for Production Release with Horizon and Octane using Github Actions](https://npratley.net/building-laravel-8-for-production-release-with-horizon-and-octane-using-github-actions-c139e66f75de/)
- [Disabling Personal Teams in Laravel 8 and Jetstream](https://npratley.net/disabling-personal-teams-in-laravel-8-and-jetstream-1fd083593e08/)
- [How To Deploy Ansible AWX on Ubuntu With MicroK8s](https://npratley.net/how-to-deploy-ansible-awx-on-ubuntu-with-microk8s-c29441ea44fd/)
<!-- BLOG-POST-LIST:END -->
<br>
